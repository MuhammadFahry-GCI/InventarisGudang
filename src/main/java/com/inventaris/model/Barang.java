...
public class Barang {
    ...
    public Barang(int idBarang, int idKategori, String kodeBarang, String namaBarang, String satuan, int stokMinimum,
            String namaKategori, int totalStok) {
    ...
    public void setStokMinimum(int sm) {
        this.stokMinimum = sm;
    }

    public void setIdKategori(int ik) {
        this.idKategori = ik;
    }
}