...
public class Gudangview {
    ...
    public Gudangview() { buildUI(); loadData(""); }
    ...
    private void buildUI() {
        ...
        TableColumn<Gudang, Integer> colId = new TableColumn<>("#");
        colId.setCellValueFactory(new PropertyValueFactory<>("idGudang"));
    ...
    private void showForm(Gudang gudang) {
        ...
        TextField tfPJ    = new TextField(gudang != null && !gudang.getPenanggungJawab().equals("-") ? gudang.getPenanggungJawab() : "");
            ...
            if (btn == ButtonType.OK) {
                ...
                if (gudang != null) {
                    ...
                    confirm.showAndWait().ifPresent(c -> {
                        if (c == ButtonType.YES) simpanGudang(gudang, tfNama, tfLokasi, tfPJ);
                    });
                } else {
    ...
    private void deleteGudang(Gudang g) {
        ...
        confirm.showAndWait().ifPresent(btn -> {
            if (btn == ButtonType.YES) {
                ...
                } catch (Exception ex) { showAlert("Error", "Gagal menghapus. Mungkin masih ada stok/transaksi terkait gudang ini."); }
            }
        });
    }
